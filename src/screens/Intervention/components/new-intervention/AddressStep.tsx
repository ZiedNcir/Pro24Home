    ...
    <>
      ...
      <AddressIntro>
        ...
        <Text variant="regularSmall" color="gray600">
          Sélectionnez une adresse enregistrée ou recherchez votre lieu
          d’intervention.
        </Text>
      </AddressIntro>
      ...
      <FullscreenMapModal
        ...
        isLookingUpAddress={addressModal.isLookingUpAddress}
        onClose={onCloseMapFullscreen}
        onSelectCoordinate={addressModal.onSelectCoordinate}
        onSearchAddress={() => {
          onCloseMapFullscreen();
          onOpenAddressModal();
        }}
