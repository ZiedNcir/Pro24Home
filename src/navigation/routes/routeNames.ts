...
export const ClientRoutes = {
  ...
  CreateRequestDescription: 'ClientCreateRequestDescription',
  CreateRequestPhotos: 'ClientCreateRequestPhotos',
  CreateRequestAddress: 'ClientCreateRequestAddress',
  CreateRequestAvailability: 'ClientCreateRequestAvailability',
  CreateRequestSummary: 'ClientCreateRequestSummary',
  CreateRequestConfirmation: 'ClientCreateRequestConfirmation',
  Matching: 'ClientMatching',
  Quote: 'ClientQuote',
  Tracking: 'ClientTracking',
  History: 'ClientHistory',
  HistoryDetail: 'ClientHistoryDetail',
